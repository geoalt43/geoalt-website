...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="bg-page-background text-text-primary w-full min-h-screen flex flex-col">
      <Navbar />
      <main className="flex-1">
        ...
        <div className="mb-4 xs:mb-6 sm:mb-8 md:mb-10 mt-1 xs:mt-2 sm:mt-2 md:mt-1">
          ...
          {/* Content */}
          <div className="policy-content prose prose-invert max-w-none space-y-3 xs:space-y-4 sm:space-y-5 md:space-y-6">
          {/* Overview */}
          <section className="mb-8 xs:mb-10 sm:mb-12 md:mb-12">
            <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl font-normal mb-1 xs:mb-0.5 sm:mb-0.5 text-text-primary leading-tight">
              Overview
            </h2>
            <p className="text-xs xs:text-sm sm:text-base md:text-base text-text-description md:leading-normal xs:leading-[1.2] mt-1 xs:mt-0.5 sm:mt-0.5 mb-2 xs:mb-3 sm:mb-4 md:mb-4">
          ...
          <section className="mb-8 xs:mb-10 sm:mb-12 md:mb-12">
            ...
            <p className="text-xs xs:text-sm sm:text-base md:text-base text-text-description md:leading-normal xs:leading-[1.2] mt-1 xs:mt-0.5 sm:mt-0.5 mb-2 xs:mb-3 sm:mb-4 md:mb-4">
              You may request access, correction, or deletion of your data by contacting <a href="mailto:contact@geoalt.in" className="text-text-primary hover:text-text-muted underline break-all">contact@geoalt.in</a>.
            </p>
          </section>
          ...
          <section className="mb-8 xs:mb-10 sm:mb-12 md:mb-12">
            ...
            <div className="space-y-2 text-base sm:text-lg md:text-lg text-text-primary md:leading-normal">
              <p>Email: <a href="mailto:contact@geoalt.in" className="text-interactive hover:text-interactive-hover underline transition-colors break-all">contact@geoalt.in</a></p>
              <p>Website: <a href="https://geoalt.in" className="text-interactive hover:text-interactive-hover underline transition-colors break-all">https://geoalt.in</a></p>
            </div>
          </section>
          </div>
        </div>
