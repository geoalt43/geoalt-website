      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {blogPosts.map((post, index) => (
            <article key={index} className="bg-black border border-gray-600 rounded-2xl p-6 hover:border-gray-500 transition-colors">
              <div className="mb-4">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-semibold text-white mb-8 text-center">Additional Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-black border border-gray-600 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Comprehensive guides and API documentation</p>
            </div>
            ...
            <div className="bg-black border border-gray-600 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Join our community of AI visibility experts</p>
            </div>
