...
function AIVisibilityCarousel() {
  ...
  return (
    <div className="lg:col-span-6 bg-black/60 border border-[#111111] rounded-2xl p-0 h-full w-[113.5%] -ml-20">
        ...
        {visibilitySlides.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="w-full overflow-hidden flex items-end -pb-34  -mb-25">
                <Image
                  src={slide.image}
    ...
    <section className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mb-6">
          ...
          <div className="lg:col-span-6 bg-black/60 border border-[#111111] rounded-2xl p-6">
            <div className="mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mb-6">
          ...
          <div className="lg:col-span-6 bg-black/60 border border-[#111111] rounded-2xl p-6 h-full w-[87%]">
            <div className="mb-4">
