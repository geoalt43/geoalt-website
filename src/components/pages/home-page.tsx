...
function AnimatedGridBackground() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-0 left-0 right-0 h-64 sm:h-80 bg-gradient-to-b from-black via-black/30 to-transparent pointer-events-none z-[5]" />
      <div className="absolute bottom-0 left-0 right-0 h-64 sm:h-80 bg-gradient-to-t from-black via-black/30 to-transparent pointer-events-none z-[5]" />
      <div className="absolute top-0 bottom-0 left-0 w-40 bg-gradient-to-r from-black via-black/30 to-transparent pointer-events-none z-[5]" />
      <div className="absolute top-0 bottom-0 right-0 w-40 bg-gradient-to-l from-black via-black/30 to-transparent pointer-events-none z-[5]" />
    ...
    <section ref={sectionRef} className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="p-6 sm:p-8 lg:p-12 relative overflow-hidden bg-black rounded-lg"
        >
          ...
          <Image
            ...
            className="w-[85%] sm:w-[88%] mx-auto h-auto object-contain relative z-10"
          />
        </motion.div>
      </div>
    </section>
