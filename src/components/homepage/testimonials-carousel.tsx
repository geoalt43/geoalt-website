      ...
      <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white rounded-lg border border-white/20 mb-8 sm:mb-12 lg:mb-14 shadow-sm"
          >
          ...
          >
            ...
            <motion.span
              variants={headerVariants}
              className="pt-0 sm:pt-2 inline-block"
            >
              about GEOAlt
            </motion.span>
          </motion.h2>
        ...
        >
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-black/60 border border-white/10 rounded-lg p-3 sm:p-5 md:p-7 shadow-lg min-h-[168px] sm:min-h-0 sm:h-full flex flex-col relative overflow-hidden group hover:border-white/25 transition-colors duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]"
            >
